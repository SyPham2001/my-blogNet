using BlogTest.Core.Domain.Content;
...
{
    public class BlogTestContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public BlogTestContext(DbContextOptions options) : base(options)
        {
